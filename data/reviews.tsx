export const reviews = [
	{
		name: "Dylan Johnson",
		photo:  require('@/images/reviewrs/Dylan Johnson.png'),
		starCount: 5,
	...
	},
	{
		...
		photo: require('@/images/reviewrs/Jacob de Champlain.png'),
		starCount: 5,
	...
	},
	{
		...
		photo: require('@/images/reviewrs/Christodoulos Nikolakoudis.png'),
		starCount: 5,
		description: "I recomment that place for your car service or for tires replacement.",
	},
	{
		name: "Vitorya Anna",
		photo: require('@/images/reviewrs/viktorya.png'),
		starCount: 5,
		description: "",
	},
