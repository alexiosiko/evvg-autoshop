		...
		<div>
			...
			{appointment.map((appointment: AppointmentTypeWithId, index) => 
				<Collapsible key={index} >
						<Card tabIndex={index} className="bg-secondary grid grid-cols-8 justify-evenly p-4 items-center text-center">
							<CardTitle>{appointment.firstname}</CardTitle>
							<CardTitle>{appointment.lastname}</CardTitle>
							<DropdownMenu>
								...
								<DropdownMenuContent>
									<DropdownMenuItem>{appointment.email}</DropdownMenuItem>
									<DropdownMenuItem>{appointment.phone}</DropdownMenuItem>
								</DropdownMenuContent>
							</DropdownMenu>
							<DropdownMenu>
								<DropdownMenuTrigger className="flex justify-center items-center gap-4">
							...
							<DropdownMenu>
								...
								<DropdownMenuContent>
									...
									<DropdownMenuItem>{appointment.notes}</DropdownMenuItem>
								</DropdownMenuContent>
							</DropdownMenu>
							<DropdownMenu>
								<DropdownMenuTrigger>
