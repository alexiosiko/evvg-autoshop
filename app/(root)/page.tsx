	...
	return (
		<div>
				...
				<div className="grid grid-cols-4 gap-6">
					{ServicesGridData.map((service, index: number) => 
						<div className="h-52 text-center shadow-md shadow-slate-800  p-4 rounded-2xl" key={index}>
							...
							<h2 className="text-2xl pb-4 font-extrabold ">{service.title}</h2>
			...
			<section className="text-center">				
					<h1 className='text-6xl font-extrabold mb-6 mt-24 gradient-text'>Contact</h1>
					<div className="flex flex-col gap-6">
						<a href="mailto:evvgauto@gmail.com.com">evvgauto@gmail.com</a>
						<a href={`tel:6045130152`}>(604) 514 - 0152</a>
						<h1>Hours</h1>
