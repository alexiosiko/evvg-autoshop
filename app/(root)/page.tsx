			...
			<section>				
				...
				<div className="grid grid-cols-4 gap-6">
					{ServicesGridData.map((service, index: number) => 
						<div className="h-52 text-center p-4 rounded-2xl outline outline-1 outline-primary bg-accent" key={index}>
							<Image className="m-auto mt-6 mb-4" width={50} height={50} src={service.img} alt="any" />
							<h2 className="text-2xl pb-4 text-primary font-extrabold ">{service.title}</h2>
